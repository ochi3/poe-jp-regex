// tools_poe2/extract_map_mods.py によって自動生成されました (PoE2-DB)
const mapModList = {
  "レアモンスターは追加のモッドを#個持つ": {
  ...
  "モンスターのライフが(##)%上昇する": {
    ...
    "map_pack_size_+%": 0,
    "map_map_item_drop_chance_+%": 15,
    "map_number_of_rare_packs_+%": 23,
    "map_number_of_magic_packs_+%": 23,
    "map_monster_potency_+%": 0
  },
  "モンスターの元素耐性 +(##)%": {
    "mod": "モンスターの元素耐性 +(##)%",
