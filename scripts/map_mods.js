const mapModList = {
  ...
  "(T17) モンスターは挑発を受けることがない|モンスターのアクションスピードは基礎値よりも低く修正されることがない|モンスターの移動スピードは基礎値よりも低く修正されることがない": {
    "mod": "(T17) モンスターは挑発を受けることがない|モンスターのアクションスピードは基礎値よりも低く修正されることがない|モンスターの移動スピードは基礎値よりも低く修正されることがない",
    "engMod": "(T17) Monsters cannot be Taunted|Monsters' Action Speed cannot be modified to below Base Value|Monsters' Movement Speed cannot be modified to below Base Value",
    "value": "1|1|1",
    "type": "Suffix",
    "weight": 40,
    "tier": 1314,
    "engRegex": "tun",
    "Regex": "礎値",
    "tradeStatId": "explicit.stat_798009319",
    "map_item_drop_quantity_+%": 13,
    "map_item_drop_rarity_+%": 8,
    "map_pack_size_+%": 5,
    "map_map_item_drop_chance_+%_final_from_uber_mod": 0,
