const originalModList = {
 ...
 "モンスターの移動スピードが#%増加する|モンスターのアタックスピードが#%増加する|モンスターのキャストスピードが%増加する": {
   ...
   engMod: "(25-30)% increased Monster Movement Speed|(35-45)% increased Monster Attack Speed|(35-45)% increased Monster Cast Speed",
   tier: 420,
   engRegex: "r at",
   Regex: "ーのキ",
   modTier17: false,
...
",
 ...
 "(T17) モンスターは物理ダメージの#%を反射する|モンスターは元素ダメージの#%を反射する": {
   ...
   engMod: "(T17) Monsters reflect 20% of Physical Damage|Monsters reflect 20% of Elemental Damage",
   tier: 2202,
   engRegex: "f ph",
   Regex: "素.*反",
   modTier17: true,
 ...
 "(T17) レアまたはユニークのモンスターはヒット時にプレイヤーまたはミニオンからライフ、マナおよびエナジーシールドの#%を取り除く": {
   ...
   engMod: "(T17) Rare and Unique Monsters remove 5% of Life, Mana and Energy Shield from Players or their Minions on Hit",
   tier: 1185,
   engRegex: "ld f",
   Regex: "はミ",
   modTier17: true,
 ...
 "(T17) モンスターアタックはヒット時に串刺しを付与する|プレイヤーに5スタック目の串刺しが付与された時に、串刺しは取り除かれプレイヤーと1.8m以内の味方に残りのヒット回数を乗じた物理ダメ―ジを反射する": {
   ...
   engMod: "(T17) Monsters' Attacks Impale on Hit When a fifth Impale is inflicted on a Player, Impales are removed to Reflect their Physical Damage multiplied by their remaining Hits to that Player and their Allies within 1.8 metres",
   tier: 1200,
   engRegex: "fif",
   Regex: "の串",
   modTier17: true,
 ...
 "(T17) モンスターのダメージは15%の元素耐性を貫通する": {
   mod: "(T17) モンスターのダメージは15%の元素耐性を貫通する",
